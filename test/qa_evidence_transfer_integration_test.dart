...
void main() {
  test('Manual QA screen exposes guarded JSON share and import actions', () {
    final source = File('lib/screens/qa_evidence_screen.dart').readAsStringSync();

    expect(source, contains("import '../services/qa_evidence_import_service.dart';"));
  ...
  test('ExternalActions limits evidence selection to JSON files', () {
    final source = File('lib/services/external_actions.dart').readAsStringSync();
