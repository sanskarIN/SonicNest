...
- No new analyzer/test/build run is claimed here unless its exact workflow run is separately observed and recorded. The existing historical green validation entries remain tied to their exact source revisions.
- The permanent workflow set is restored to the maintained six workflows; temporary one-shot workflow/helper files used during this continuation are removed from the final tree.
...
- `856617aa08235e424a629c9c9c999d2bbc8a2f2e` — canonical Dart formatting for the completed transfer source.
