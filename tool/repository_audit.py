...
def audit() -> list[str]:
    ...
    require_fragments(
        ...
        (
            ...
            "--output /tmp/sonicnest-release-readiness.json",
            "python3 tool/verify_release_readiness_report.py /tmp/sonicnest-release-readiness.json",
        ),
