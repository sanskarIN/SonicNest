...
extension RecordingFormatX on RecordingFormat {
  ...
  AudioEncoder get nativeEncoder => switch (this) {
    ...
    RecordingFormat.mp3 ||
    RecordingFormat.ogg ||
    RecordingFormat.aac => AudioEncoder.wav,
  };
}
...
class RecordingSettings {
  ...
  factory RecordingSettings.forPreset(QualityPreset preset) {
    return switch (preset) {
      ...
      QualityPreset.meeting ||
      QualityPreset.lecture ||
      QualityPreset.interview => RecordingSettings(
        format: RecordingFormat.m4a,
        preset: preset,
        bitRate: 128000,
        sampleRate: 48000,
      ...
      QualityPreset.music || QualityPreset.highQuality => RecordingSettings(
        ...
        namingTemplate: defaultRecordingNameTemplate,
        namingSuffix: '',
        namingCategory: preset == QualityPreset.music
            ? 'Music'
            : 'High Quality',
        countdownSeconds: 0,
        keepScreenAwake: true,
